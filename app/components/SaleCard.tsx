...
const SaleCard = () => {
  return (
    <div className="my-10 rounded-3xl overflow-hidden bg-linear-to-br from-indigo-600 via-indigo-400 to-indigo-200 border border-gray-100 shadow-sm flex items-center max-[900px]:flex-col">
